...
while True:
    ...
    image = cv2.putText(bordered_frame, threshold_class, (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 
    ...
    if cv2.waitKey(2) & 0xFF == ord('q'):
        ...
        computer = options[random.randrange(1,4)-1]
        # print(computer)
        print(user)
        # user = input("Pick one: ")
        ...
        #     print("you win bc computer picked scissors")
        # elif user.lower() == "scissors" and computer == "paper":
        #     print("you win bc computer picked paper")
        # elif user.lower() == "paper" and computer == "rock":
        #     print("you win bc computer picked rock")
        # else:
        #     print("you lose bc computer picked " + computer)
